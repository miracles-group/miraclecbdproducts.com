        ...
        return (
            <Layout>
                <div>
                    ...
                    <p>Our products are made from the hemp plant and contain no THC.This means you will enjoy all of the benefits of CBD without the high, and it is le-gal to sell and consume in all 50 states!</p>
                    <p>We stand behind our products and its quality.Everything we produce is rigor-ously tested for its purity and quality.When we deliver our product, our cus-tomers are assured that they are receiving the highest quality CBD product they could ask for.</p>
                    <p>As an Miracle DropShip Partner, you can expect to deliver high quality and potent products to your customers.  Our Miracle CBD product catalog is con-tinuously growing and currently has over 80 CBD products which vary from oils, pills, edibles, beauty and skincare, pain relief, e-liquids to pet and equestrian products.  You will find that the target audience for our products isvast and is only getting larger as more people are educated on the CBD in-dustry.</p>
                    <h3>How it Works:</h3>
                    ...
                    <p className="note">Please Note:  You must be enrolled into our program and have an active deposit account with us for any orders to be fulfilled.   Failure to be enrolled or not havingan active deposit account will result in your customers not receiving their prod-ucts.</p>
                    <h3>About Our Products:</h3>
                    <p>Miracle Nutritional Products offers over 80 different CBD products available to sell through your platform.  All of our products are Made in the USA using industrial hemp sourced from Kentucky.  Because our products are hemp-based, they contain no THC and are legal to consume in all 50 states.  Every one of our products is 3rd party lab tested and approved for quality and accu-racy, which means your customers can be rest assured the product they re-ceive is exactly what they ordered.</p>
                    ...
                    <h3>About Us:</h3>
                    <p>At Miracle Nutritional Products, we believe in natural alternative treatment usingCannabidiol (CBD). Our vision is to create quality CBD products that are an effec-tive form of alternative treatment.</p>
                    ...
                    <p>Our Miracle Nutritional Products are being sold in over 9,000 store locations across the United States and Europe with rapid growth with over 300 private la-bel partners.</p>
                    <p>Forbes magazine stated that the CBD industry is currently at $220 Million dollarsin 2017. Forbes has projected that by 2021 the CBD industry will surpass 2.6 BILLION dollars. That is a projected growth of over 500%</p>
                    <h3>Support</h3>
